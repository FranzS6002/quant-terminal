...
def check_password():
    def password_entered():
        ...
        try:
            # 1. Priorität: Suche das sichere Passwort in der Streamlit Cloud
            geheimnis = st.secrets["app_password"]
        except (KeyError, FileNotFoundError):
            # 2. Priorität: Fallback für lokale Tests auf deinem PC
            geheimnis = "Quant24!" 
            
        if eingabe == geheimnis:
            st.session_state["password_correct"] = True
            # Aus Sicherheitsgründen Passwort aus dem State löschen
            del st.session_state["password"] 
        else:
            st.session_state["password_correct"] = False
            # Optional, aber gut: Bei Falscheingabe das Feld sofort wieder leeren
            if "password" in st.session_state:
                del st.session_state["password"]

    # Wenn bereits einmal richtig eingeloggt wurde, direkt durchwinken
    ...
    # FEHLTE VORHER: Das visuelle Feedback bei falschem Passwort!
    if "password_correct" in st.session_state and not st.session_state["password_correct"]:
        st.error("❌ Falsches Passwort. Bitte erneut versuchen.")
        
    return False

# Ausführung stoppen, wenn das Passwort (noch) nicht korrekt ist
...
DEFAULT_SHOW_REAL_LIFE = False 

# ==========================================
# 1. UNIVERSEN DEFINIEREN
# ==========================================
sat_tickers = {
    # --- 🏛️ DEIN BESTEHENDES UNIVERSUM ---
    "JEDI.DE": "Space Innovators",
    "HNSC.MI": "Semiconductors",
    "ETLX.DE": "L&G Gold Min.",
    "U3O8.DE": "Uranium Miners",
    "1IZ1.F": "Scottish Mortgage",
    "LYM9.DE": "MSCI New Energy",
    "GRID.DE": "Smart Grid Infrastr.",
    "4MMR.DE": "Glob.X Def.Tech",
    "DFEN.DE": "VanEck Defense",
    "ARAW.DE": "Raw Materials",
    "QUTM.DE": "Quantum Comp.",
    "MTVR.DE": "Metaverse",
    "IS0D.DE": "Oil & Gas E&P",
    "V9N.DE": "Data Centers",
    "IEVD.DE": "EV Driving Tech",
    "XMOV.DE": "Future Mobility",
    "XAIX.DE": "AI & Big Data",
    "ZPRR.DE": "Russell 2000",
    "EXSC.DE": "Europe Small",
    "2B76.DE": "Robo & Automation",
    "WTAI.DE": "Applied AI",
    "EUFN": "Europe Financials",
    "GNOM.MI": "Genomics",
    "XDPE.DE": "Private Equity",
    "2B77.DE": "Ageing Pop",
    "GOAI.DE": "Robotics & AI",
    "REUSE.MI": "Circular Economy",
    "SNSR.MI": "IoT",
    "XUFN.DE": "USA Financials",
    "XNGI.DE": "Next Gen",
    "HYCN.DE": "Global X Hydrogen",
    "BATE.DE": "Battery Value Chain",
    "AMEC.DE": "MSCI Smart Cities",
    
    # --- 🔄 RESTAURIERTE HISTORIE (Für sauberes Backtesting) ---
    "BTC-USD": "Bitcoin",
    "IGV": "Software B2B",
    "XFNT.DE": "Fintech Innovation",
    "CLOU.MI": "Cloud Computing",
    "IQQQ.DE": "Water",
    "CBRS.DE": "F.T.Cybersecurity",
...
if not data.empty:
                    ...
                    if len(cands_to_buy) > 0:
                        ...
                        for tkr in cands_to_buy:
                            if cash_per_asset > real_fee:
                                ...
                                cash -= cash_per_asset
                                total_fees += real_fee
                                holdings[tkr] = {'shares': shares, 'buy_price': buy_price}
    ...
    if show_manual:
        ...
        if app_mode == "🚀 Satelliten (Offensive)":
            ...
            * **Säule 2: SMA 85 & 3,2 % Puffer (Die absolute Notbremse):** Fällt der Kurs auf Tagesschlussbasis unter dieses Puffer-Level der 85-Tage-Linie, wird **sofort am nächsten Tag verkauft**, um existenzielle Drawdowns zu vermeiden.
